...
export const translations = {
  en: {
    ...
    donation_card_message: "Your donations help keep our mosque services running.",
    support_mosque_title: "Support Our Mosque",
  ...
  tr: {
    ...
    donation_card_message: "Cami faaliyetlerimizin devamı için bağışlarınız çok kıymetli.",
    support_mosque_title: "Camimize Destek Olun",
